...
class GenderV2 extends Component{
    constructor(){
        super();
        this.state={
            gender:"",
    ...
    _renderGender=(e)=>{
        ...
        e.target.value==='male'?this.setState({gender:'male'}):this.setState({gender:"female"})
    }
    _renderMaritalStatus=(e)=>{
        ...
        e.target.checked ?this.setState({isMarried:"Married"}):this.setState({isMarried:""})
    }
    render(){
        return(
            <>
